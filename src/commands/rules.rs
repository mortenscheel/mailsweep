        ...
        match self.command {
            ...
            RulesCommands::Edit => {
                ...
                if is_new {
                    ...
                    println!(
                        "Editor: {} (set $EDITOR environment variable to change)",
                        editor
                    );
                ...
                // Open editor
                let status = Command::new(editor).arg(&rules_path).status()?;
            ...
            RulesCommands::Add {
                ...
                let rule_action = match action_lower.as_str() {
                    ...
                    _ => {
                        anyhow::bail!(
                            "Invalid action: '{}'. Must be one of: archive, delete, mark_read",
                            action
                        );
                    }
                };
